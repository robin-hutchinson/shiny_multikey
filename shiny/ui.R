...
UKCEH_titlePanel <- function(title = 'UKCEH Shiny app', windowTitle = title){
  ...
  div(
    img(src='https://www.ceh.ac.uk/sites/default/files/images/theme/ukceh_logo_long_720x170_rgb.png
...
ui <- bslib::page_fluid(theme = UKCEH_theme,
...
layout_columns(card(tags$span(uiOutput('results1taxa')),
                                      ...
                                      tags$span(uiOutput('results1unmatched'))),
                                  card(tags$span(uiOutput('results2taxa')),
                                       tags$span(uiOutput('results2matched')),
                                       tags$span(uiOutput('results2unmatched'))))))
